...
from syntax_definitions import syntax_nodes, Node_Kind, Lookup_Kind
...
def main():
    header = open("./compiler/glang_syntax/syntax_accessors.hpp", "w")
    source = open("./compiler/glang_syntax/syntax_accessors.cpp", "w")
    ...
    process = subprocess.run(["clang-format", "-i", "./compiler/glang_syntax/syntax_accessors.hpp", "./compiler/glang_syntax/syntax_accessors.cpp"])
